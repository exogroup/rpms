...
%exclude %{_bindir}/[cirt]*
%exclude %{_mandir}/man1/[cirt]*
%exclude %{_mandir}/man5/*
%exclude %{_mandir}/man7/*

%exclude %{_libdir}/libncurses++*.so.6*
%exclude %{_libdir}/lib*.so.6*

%exclude %{_libdir}/libncurses++*.so.6*

%exclude %dir %{_sysconfdir}/terminfo
%exclude %{_datadir}/tabset
%exclude %dir %{_datadir}/terminfo

%exclude %{_datadir}/terminfo

%exclude %{_bindir}/ncurses*-config
%exclude %{_libdir}/lib*.so
%exclude %{_libdir}/pkgconfig/*.pc
%exclude %dir %{_includedir}/ncurses
%exclude %dir %{_includedir}/ncursesw
%exclude %{_includedir}/ncurses/*.h
%exclude %{_includedir}/ncursesw/*.h
%exclude %{_includedir}/*.h
%exclude %{_mandir}/man1/ncurses*-config*
%exclude %{_mandir}/man3/*

%exclude %{_libdir}/lib*.a

%changelog
* Wed Nov  8 2023 Matthias Saou <matthias@saou.eu> 6.2-10.20210508.1
- Rip our all except ncurses-compat-libs to have it as a standalone package.
